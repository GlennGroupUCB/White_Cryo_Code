...
try: #allows you to kill the loop with ctrl c
	while True: #Just loop for every never stopping the monitoring of the temperatures
		...
		if t>30*60 and t<18000*60: #70,800
		...
		if t>100*60 and t<600*60:
			...
			if lk224_TC4>35.: #just in case
				ag47b.write('INST:SEL OUT1')
				ag47b.write('Volt 0')
		elif t>600*60 and lk224_A<0.5: #keep the switches on until the 300mK stage heats up
			if lk224_TC4<29.:
				ag47b.write('INST:SEL OUT1')
				ag47b.write('Volt 4')
			if lk224_TC4>30.: #temp should drop slowly
		...
		if t>200*60 and t<600*60:
			...
			if lk224_TC5>35.: #just in case
				ag47b.write('INST:SEL OUT2')
				ag47b.write('Volt 0')
		elif t>600*60 and lk224_A<0.5: #keep the switchs on until 300mK stage warms up
			if lk224_TC5<30.:
				ag47b.write('INST:SEL OUT2')
				ag47b.write('Volt 3.6')
			if lk224_TC5>30.: #temp should drop slowly
		...
		if i == 0:
			legend = plt.legend(ncol = 2,loc = 1, bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True)
		plt.xlim(x[0],x[419])
		plt.ylim(0.1,300)
